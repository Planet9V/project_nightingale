## This is a Metaprompt, it produces high quality prompts.

What is it used for?
- Blog Post
- Generate a Blog from a Youtube Script
- Analyse Aggregate perpsective from HackerNews

## Guide

Claude 3.5 Sonnet and o1 series models are recommended for meta prompting.
Replace `{{user-input}}` with your own input to generate prompts.
Use `mp_*.txt` as example `user-input`s to see how to generate high quality prompts.

## Metaprompt Content (Use this)
